...
clear all
clc
Path='G:\WCJ-Data\双压杆社会抉择-WCJ\ACC数据\Figure 电生理\ACC电生理分析\DACC-plexondata\处理后的nex5文件\pre\GPFA\';
Name='20220217-DACC-6-pre-01_GPFA.mat';
...
for i=1:length(dat)
    ...
    dat(i).spikes=dat(i).count_bin(:,41:80);
