...
for curr_animal=1:length(animals)
    ...
    for curr_file=1:2
        %处理event数据
        event_file=dir(fullfile(Path, aanimal ,recording_files{curr_file} ,'*data_m1.csv'));
        ...
        for curr_cell=1:length(spike_times)
           ...
           saveas(gcf, fullfile(Path,[ animal '_day_' num2str(curr_file) 'PSTH.jpg']),'jpg')
