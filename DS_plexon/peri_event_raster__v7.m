...
for curr_animal=1:length(animals)
    ...
    for curr_file=1:2
        ...
        event_times{1}=sort(data_event_sorted(data_event_sorted(:,1)==17,4));
        event_times{2}=sort(data_event_sorted(data_event_sorted(:,1)==71,4));
        event_times{3}=sort(data_event_sorted(data_event_sorted(:,1)==26,4));
        event_times{4}=sort(data_event_sorted(data_event_sorted(:,1)==62,4));
        event_times{5}=sort(data_event_sorted(data_event_sorted(:,1)==35,4));
        event_times{6}=sort(data_event_sorted(data_event_sorted(:,1)==53,4));
  event_times{7}=sort(data_event_sorted(:,4));
